...
4. **Algemene gezondheid** — median Performance Score, median SEO Score, median page weight, pages analyzed. Include a Status column for both scores using emoji: 🟢 Goed (≥ 90), 🟠 Verbetering nodig (50–89), 🔴 Slecht (< 50). Leave Status empty for page weight and page count rows.
